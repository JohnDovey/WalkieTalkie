...
Keep this manual up to date as the app develops — add or update a chapter whenever a user-facing feature changes. Topic chapters include Getting Started, platform builds, Android / iPhone / Wearables, The Base Station, **MeshBridge**, and **MeshSniff**.
