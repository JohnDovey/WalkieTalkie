...
| [TODO-p2p-voice-and-private-relay.md](TODO-p2p-voice-and-private-relay.md) | Deferred: P2P voice notes, live private WebRTC/SFU, multi-Base blob sync (mesh SFU for force-relay is shipped) |
